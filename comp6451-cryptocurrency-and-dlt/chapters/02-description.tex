...
Hashgraph uses standard cryptographic hashes and digital signatures to securely spread events across a network with the use of a gossip(Figure 1).%\ref{fig:hashgraph}).
