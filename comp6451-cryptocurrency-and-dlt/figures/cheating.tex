\begin{figure}
    ...
    \caption{
        ...
        she could double spend her coins by gossiping two different events (x \& y) to different members. The Strongly Seeing Lemma states that a forked event will not be strongly seen by other members. A proof by contradiction shows that if 2/3 strongly sees x and 2/3 also strongly sees y, then this is impossible if only less than 1/3 are malicious. If Alice, Bob, and Carol are honest, they will not strongly see Mallory's events as valid.
    }
\end{figure}
